...
from PySide6.QtWidgets import QApplication, QWidget, QFileDialog, QVBoxLayout, QPushButton, QColorDialog, QHBoxLayout, QLabel, QSlider
...
class LexipEditor(QWidget):
    ...
    def _dist_to_segment(self, px, py, x1, y1, x2, y2):
        ...
        return ((px - (x1 + t * C)) ** 2 + (py - (y1 + t * D)) ** 2) ** 0.5
